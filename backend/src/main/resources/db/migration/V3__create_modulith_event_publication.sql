-- Spring Modulith JPA event publication registry (PostgreSQL).
-- See https://docs.spring.io/spring-modulith/reference/appendix.html#appendix-event-publication-registry-schemas
